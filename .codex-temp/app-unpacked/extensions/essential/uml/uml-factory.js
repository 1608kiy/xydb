...
function featureLinkPrecondition(options) {
  app.factory.assert(
    options.tailModel instanceof type.UMLFeature &&
      options.headModel instanceof type.UMLFeature,
    Mustache.render(ERR_INVALID_LINK, options.modelType),
  );
}
...
function classifierLinkPrecondition(options) {
  app.factory.assert(
    options.tailModel instanceof type.UMLClassifier &&
      options.headModel instanceof type.UMLClassifier,
    Mustache.render(ERR_INVALID_LINK, options.modelType),
  );
}
...
function roleBindingPrecondition(options) {
  app.factory.assert(
    options.tailModel instanceof type.UMLCollaborationUse &&
      options.headModel instanceof type.UMLAttribute,
    Mustache.render(ERR_INVALID_LINK, options.modelType),
  );
}
...
function componentRealizationPrecondition(options) {
  app.factory.assert(
    options.tailModel instanceof type.UMLClassifier &&
      options.headModel instanceof type.UMLComponent,
    Mustache.render(ERR_INVALID_LINK, options.modelType),
  );
}
...
function deploymentPrecondition(options) {
  app.factory.assert(
    (options.tailModel instanceof type.UMLClassifier &&
      options.headModel instanceof type.UMLNode) ||
      (options.tailModel instanceof type.UMLInstance &&
        options.headModel instanceof type.UMLNodeInstance),
    Mustache.render(ERR_INVALID_LINK, options.modelType),
  );
}
...
function nodeLinkPrecondition(options) {
  app.factory.assert(
    options.tailModel instanceof type.UMLNode &&
      options.headModel instanceof type.UMLNode,
    Mustache.render(ERR_INVALID_LINK, options.modelType),
  );
}
...
function instanceLinkPrecondition(options) {
  app.factory.assert(
    options.tailModel instanceof type.UMLInstance &&
      options.headModel instanceof type.UMLInstance,
    Mustache.render(ERR_INVALID_LINK, options.modelType),
  );
}
...
function useCaseLinkPrecondition(options) {
  app.factory.assert(
    options.tailModel instanceof type.UMLUseCase &&
      options.headModel instanceof type.UMLUseCase,
    Mustache.render(ERR_INVALID_LINK, options.modelType),
  );
}
...
function flowPrecondition(options) {
  app.factory.assert(
    (options.tailModel instanceof type.UMLPin ||
      options.tailModel instanceof type.UMLActivityNode) &&
      (options.headModel instanceof type.UMLPin ||
        options.headModel instanceof type.UMLActivityNode),
    Mustache.render(ERR_INVALID_LINK, options.modelType),
  );
}
...
function extensionPrecondition(options) {
  app.factory.assert(
    options.tailModel instanceof type.UMLStereotype &&
      options.headModel instanceof type.UMLMetaClass,
    Mustache.render(ERR_INVALID_LINK, options.modelType),
  );
}
...
function compositeStructureDiagramFn(parent, options) {
  ...
  if (parent instanceof type.UMLClassifier) {
    ...
    collaboration.name = Element.getNewName(
...
function sequenceDiagramFn(parent, options) {
  ...
  if (parent instanceof type.UMLInteraction) {
    ...
    collaboration._parent = parent;
    interaction = new type.UMLInteraction();
    interaction.name = Element.getNewName(
      collaboration.ownedElements,
      "Interaction",
    );
...
function statechartDiagramFn(parent, options) {
  ...
  if (parent instanceof type.UMLStateMachine) {
    ...
    stateMachine.name = Element.getNewName(
      parent.ownedElements,
      "StateMachine",
    );
...
function associationClassFn(parent, diagram, options) {
  var model, view;
  app.factory.assert(
    (options.tailModel instanceof type.UMLClass &&
      options.headModel instanceof type.UMLAssociation) ||
      (options.headModel instanceof type.UMLClass &&
        options.tailModel instanceof type.UMLAssociation) ||
      (options.tailModel instanceof type.UMLClassifier &&
        options.headModel instanceof type.UMLClassifier),
  ...
  if (
    options.tailModel instanceof type.UMLClassifier &&
    options.headModel instanceof type.UMLClassifier &&
    !(options.tailModel instanceof type.UMLNaryAssociationNode) &&
    !(options.headModel instanceof type.UMLNaryAssociationNode)
  ) {
    // NaryAssociationNode가 아닌 두 개의 Classifier를 연결한 경우 : Class, Association, AssociationClassLink를 생성.
    ...
    associationClassLinkView.initialize(
      null,
      midX,
      midY,
      midX + CLASS_DISTANCE,
    ...
    if (
      ...
      // Class에서 NaryAssociationNode로 연결한 경우 : AssociationClassLink를 생성.
      model.classSide = options.tailModel;
      model.associationSide = options.headModel;
      view.tail = options.tailView;
      view.head = options.headView;
      ...
      // NaryAssociationNode에서 Class로 연결한 경우 : AssociationClassLink를 생성.
      model.classSide = options.headModel;
      model.associationSide = options.tailModel;
      view.tail = options.headView;
      view.head = options.tailView;
...
function interfaceRealizationFn(parent, diagram, options) {
  ...
  app.factory.assert(
    (options.tailModel instanceof type.UMLClassifier &&
      options.headModel instanceof type.UMLInterface) ||
      (options.tailModel instanceof type.UMLPort &&
        options.headModel instanceof type.UMLInterface),
    Mustache.render(ERR_INVALID_LINK, "Interface Realization"),
  );
  if (options.tailModel instanceof type.UMLPort) {
    app.factory.assert(
      options.tailModel.type instanceof type.UMLClassifier,
      "Port should have type to create Interface Realization",
    );
    if (options.tailModel.type instanceof type.UMLClassifier) {
      var rs = app.repository.getRelationshipsOf(
        options.tailModel.type,
        function (r) {
          return (
...
function linkObjectFn(parent, diagram, options) {
  var model, view;
  app.factory.assert(
    (options.tailModel instanceof type.UMLObject &&
      options.headModel instanceof type.UMLLink) ||
      (options.headModel instanceof type.UMLObject &&
        options.tailModel instanceof type.UMLLink) ||
      (options.tailModel instanceof type.UMLInstance &&
        options.headModel instanceof type.UMLInstance),
...
function lifelineFn(parent, diagram, options) {
  ...
  app.factory.assert(
    parent instanceof type.UMLInteraction &&
      parent._parent instanceof type.UMLClassifier,
  ...
  if (diagram instanceof type.UMLSequenceDiagram) {
    ...
    app.factory.assert(
      ...
      "UMLLifeline should be placed inside a frame in Timing Diagram",
    );
  ...
  builder.fieldInsert(diagram, "ownedViews", view);
  if (
    diagram instanceof type.UMLTimingDiagram &&
    options.tailView instanceof type.UMLTimingFrameView
  ) {
  ...
  if (diagram instanceof type.UMLSequenceDiagram) {
    ...
    app.factory.assert(
      (options.tailView instanceof type.UMLLinePartView ||
        options.tailView instanceof type.UMLMessageEndpointView) &&
        (options.headView instanceof type.UMLLinePartView ||
          options.headView instanceof type.UMLMessageEndpointView),
    ...
    if (
      options.tailView instanceof type.UMLCommLifelineView &&
      options.headView instanceof type.UMLCommLifelineView
    ) {
      ...
      view.initialize(
        null,
        connectorView.points.points[0].x,
        connectorView.points.points[0].y,
        connectorView.points.points[0].x,
        connectorView.points.points[0].y,
      );
      if (options.viewInitializer) {
    ...
    app.factory.assert(
      options.tailView instanceof type.UMLTimeSegmentView &&
        options.headView instanceof type.UMLTimeSegmentView,
...
function foundMessageFn(parent, diagram, options) {
  ...
  endpoint.name = Element.getNewName(
    parent.participants,
    endpoint.getDisplayClassName(),
  );
...
function stateInvariantFn(parent, diagram, options) {
  ...
  if (diagram instanceof type.UMLTimingDiagram) {
    ...
    console.log(options);
    var vv = diagram.getBottomViewAt(
...
function timingStateFn(parent, diagram, options) {
  var model, view;
  app.factory.assert(
    options.tailView instanceof type.UMLTimingLifelineView ||
  ...
  model.name = Element.getNewName(
    options.tailModel.ownedElements,
    "State-Condition",
  );
...
function timeTickFn(parent, diagram, options) {
  ...
  view._parent = diagram;
  view.width =
    Math.max(view.width, options.editor.canvas.gridFactor.width * 3) - 1; // min width when created
  view.containerView = options.tailView;
  if (options.viewInitializer) {
    options.viewInitializer(view);
  }
...
function durationConstraintFn(parent, diagram, options) {
  ...
  let frame = null;
  if (diagram instanceof type.UMLTimingDiagram) {
    var bv = diagram.getBottomViewAt(
      options.editor.canvas,
      options.x2,
      options.y2,
    );
...
function interactionUseInOverviewFn(parent, diagram, options) {
  ...
  interaction = new type.UMLInteraction();
  interaction.name = Element.getNewName(
    interactionOwner.ownedElements,
    "Interaction",
  );
  ...
  interactionUse.name = Element.getNewName(
...
function connectorFn(parent, diagram, options) {
  ...
  if (diagram instanceof type.UMLCommunicationDiagram) {
    ...
    app.factory.assert(
      options.tailModel instanceof type.UMLLifeline &&
        options.headModel instanceof type.UMLLifeline,
      Mustache.render(ERR_INVALID_LINK, "Connector"),
    );
    app.factory.assert(
      options.tailModel.represent instanceof type.UMLFeature &&
        options.headModel.represent instanceof type.UMLFeature,
      Mustache.render(ERR_INVALID_LINK, "Connector"),
    );
    ...
    return app.factory.defaultUndirectedRelationshipFn(
      parent,
      diagram,
      options,
    );
...
function submachineStateFn(parent, diagram, options) {
  ...
  stateMachine = new type.UMLStateMachine();
  stateMachine.name = Element.getNewName(
    parent._parent.ownedElements,
    stateMachine.getDisplayClassName(),
  );
  ...
  model = new type.UMLState();
  model.name = Element.getNewName(
    parent.regions[0].vertices,
    model.getDisplayClassName(),
  );
...
function pseudostateFn(parent, diagram, options) {
  var model, view;
  options.pseudostateKind =
    options.pseudostateKind || type.UMLPseudostate.PSK_INITIAL;
  app.factory.assert(
    parent instanceof type.UMLStateMachine,
...
function transitionFn(parent, diagram, options) {
  var model, view;
  app.factory.assert(
    options.tailModel instanceof type.UMLVertex &&
      options.headModel instanceof type.UMLVertex,
...
function viewForGeneralDiagramFn(model, diagram, options) {
  ...
  if (model instanceof type.UMLPort) {
    ...
    if (
      ((containerView instanceof type.UMLClassifierView ||
        containerView instanceof type.UMLSubsystemView) &&
        containerView.model === model._parent) ||
      (containerView instanceof type.UMLPartView &&
    ...
    var port1View =
      diagram.getViewOf(model.end1.reference, type.UMLPortView) ||
      diagram.getViewOf(model.end1.reference, type.UMLPartView);
    var port2View =
      diagram.getViewOf(model.end2.reference, type.UMLPortView) ||
      diagram.getViewOf(model.end2.reference, type.UMLPartView);
    if (connectorView) {
      ...
      if (!port2View) {
        var port2ContainerView = diagram.getViewOf(
          model.end2.reference._parent,
        );
        if (!port2ContainerView) {
          app.factory.createViewAndRelationships(
            editor,
            x,
            y,
            model.end2.reference._parent,
      ...
      if (!port1View) {
        var port1ContainerView = diagram.getViewOf(
          model.end1.reference._parent,
        );
      ...
      if (port1View && port2View) {
        ...
        connectorView.initialize(
          null,
          connectorView.tail.left,
          connectorView.tail.top,
          connectorView.head.left,
          connectorView.head.top,
        );
        if (options.viewInitializer) {
    ...
    if (directedView) {
      ...
      if (targetView && sourceView) {
        ...
        if (DirectedViewType) {
          ...
          directedView.initialize(
            null,
            directedView.tail.left,
            directedView.tail.top,
            directedView.head.left,
            directedView.head.top,
          );
          if (options.viewInitializer) {
    ...
    if (undirectedView) {
      ...
      if (end1View && end2View) {
        ...
        if (UndirectedViewType) {
          ...
          undirectedView.initialize(
            null,
            undirectedView.tail.left,
            undirectedView.tail.top,
            undirectedView.head.left,
            undirectedView.head.top,
          );
          if (options.viewInitializer) {
...
function viewForSequenceDiagramFn(model, diagram, options) {
  ...
  if (model instanceof type.UMLClassifier) {
    ...
    sourceView =
      sourceView instanceof type.UMLSeqLifelineView
        ? sourceView.linePart
        : sourceView;
    targetView =
      targetView instanceof type.UMLSeqLifelineView
        ? targetView.linePart
        : targetView;
...
function viewForCommunicationDiagramFn(model, diagram, options) {
  ...
  if (model instanceof type.UMLClassifier) {
    ...
    var _ev1 = _.find(diagram.ownedViews, function (v) {
      return (
        v instanceof type.UMLCommLifelineView &&
        v.model.represent === model.end1.reference
      );
    });
    var _ev2 = _.find(diagram.ownedViews, function (v) {
      return (
        v instanceof type.UMLCommLifelineView &&
        v.model.represent === model.end2.reference
      );
    });
    if (_ev1 && _ev2) {
      view = new type.UMLConnectorView();
    ...
    if (model.connector) {
      ...
      var _tailView = _.find(diagram.ownedViews, function (v) {
        return v.model === model.source;
      });
      var _headView = _.find(diagram.ownedViews, function (v) {
...
function viewForInteractionOverviewDiagramFn(model, diagram, options) {
  ...
  if (
    ...
    model instanceof type.UMLSequenceDiagram
  ) {
    const builder = app.repository.getOperationBuilder();
    builder.begin("add element");
    if (
      model instanceof type.UMLInteraction &&
      parent._parent instanceof type.UMLInteraction
    ) {
...
function viewForStatechartDiagramFn(model, diagram, options) {
  ...
  if (model instanceof type.UMLConnectionPointReference) {
    if (
      containerView instanceof type.UMLStateView &&
      containerView.model === model._parent
    ) {
      return app.factory.createViewAndRelationships(
        editor,
...
function viewForActivityDiagramFn(model, diagram, options) {
  ...
  if (model instanceof type.UMLInputPin || model instanceof type.UMLOutputPin) {
    if (
      containerView instanceof type.UMLActionView &&
      containerView.model === model._parent
    ) {
      return app.factory.createViewAndRelationships(
        editor,
...
app.factory.registerDiagramFn(
  "UMLCompositeStructureDiagram",
  compositeStructureDiagramFn,
);
...
app.factory.registerModelAndViewFn(
  "UMLAssociation",
  _undirectedRelationshipFn,
  { precondition: classifierLinkPrecondition },
);
...
app.factory.registerModelAndViewFn("UMLDependency", _directedRelationshipFn, {
  precondition: modelElementLinkPrecondition,
});
app.factory.registerModelAndViewFn(
  "UMLGeneralization",
  _directedRelationshipFn,
  { precondition: classifierLinkPrecondition },
);
app.factory.registerModelAndViewFn(
  "UMLInterfaceRealization",
  interfaceRealizationFn,
);
app.factory.registerModelAndViewFn(
  "UMLTemplateBinding",
  _directedRelationshipFn,
...
app.factory.registerModelAndViewFn("UMLRoleBinding", _directedRelationshipFn, {
  precondition: roleBindingPrecondition,
});
app.factory.registerModelAndViewFn("UMLRealization", _directedRelationshipFn, {
  precondition: modelElementLinkPrecondition,
});
...
app.factory.registerModelAndViewFn(
  ...
  _directedRelationshipFn,
  { precondition: componentRealizationPrecondition },
);

// Deployments
app.factory.registerModelAndViewFn("UMLNode", _modelAndViewFn);
app.factory.registerModelAndViewFn("UMLDeployment", _directedRelationshipFn, {
  precondition: deploymentPrecondition,
});
app.factory.registerModelAndViewFn(
  "UMLCommunicationPath",
  _undirectedRelationshipFn,
  { precondition: nodeLinkPrecondition },
);
...
app.factory.registerModelAndViewFn("UMLLink", _undirectedRelationshipFn, {
  precondition: instanceLinkPrecondition,
});
...
app.factory.registerModelAndViewFn("UMLInclude", _directedRelationshipFn, {
  precondition: useCaseLinkPrecondition,
});
app.factory.registerModelAndViewFn("UMLExtend", _directedRelationshipFn, {
  precondition: useCaseLinkPrecondition,
});

// Interactions
app.factory.registerModelAndViewFn("UMLLifeline", lifelineFn);
app.factory.registerModelAndViewFn("UMLEndpoint", _modelAndViewFn, {
  precondition: interactionPrecondition,
  field: "participants",
});
app.factory.registerModelAndViewFn("UMLGate", _modelAndViewFn, {
  precondition: interactionPrecondition,
  field: "participants",
});
...
app.factory.registerModelAndViewFn("UMLContinuation", _modelAndViewFn, {
  precondition: interactionPrecondition,
  field: "fragments",
});
app.factory.registerModelAndViewFn("UMLCombinedFragment", combinedFragmentFn);
app.factory.registerModelAndViewFn("UMLInteractionUse", _modelAndViewFn, {
  precondition: interactionPrecondition,
  field: "fragments",
});
...
app.factory.registerModelAndViewFn(
  ...
  durationConstraintFn,
);
app.factory.registerModelAndViewFn(
  "UMLInteractionUseInOverview",
  interactionUseInOverviewFn,
);
app.factory.registerModelAndViewFn(
  "UMLInteractionInOverview",
  interactionInOverviewFn,
);
app.factory.registerModelAndViewFn("UMLFrame", _viewOnlyFn, {
  viewType: "UMLFrameView",
});
...
app.factory.registerModelAndViewFn(
  ...
  connectionPointReferenceFn,
);
app.factory.registerModelAndViewFn("UMLTransition", transitionFn);

// Activities
app.factory.registerModelAndViewFn("UMLAction", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "nodes",
});
app.factory.registerModelAndViewFn("UMLObjectNode", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "nodes",
});
app.factory.registerModelAndViewFn("UMLCentralBufferNode", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "nodes",
});
app.factory.registerModelAndViewFn("UMLDataStoreNode", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "nodes",
});
app.factory.registerModelAndViewFn(
  ...
  _modelAndViewFn,
  { precondition: activityPrecondition, field: "nodes" },
);
app.factory.registerModelAndViewFn("UMLInitialNode", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "nodes",
});
app.factory.registerModelAndViewFn("UMLActivityFinalNode", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "nodes",
});
app.factory.registerModelAndViewFn("UMLFlowFinalNode", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "nodes",
});
app.factory.registerModelAndViewFn("UMLForkNode", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "nodes",
});
app.factory.registerModelAndViewFn("UMLJoinNode", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "nodes",
});
app.factory.registerModelAndViewFn("UMLMergeNode", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "nodes",
});
app.factory.registerModelAndViewFn("UMLDecisionNode", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "nodes",
});
app.factory.registerModelAndViewFn("UMLInputPin", _modelAndViewFn, {
  precondition: pinPrecondition,
  field: "inputs",
});
app.factory.registerModelAndViewFn("UMLOutputPin", _modelAndViewFn, {
  precondition: pinPrecondition,
  field: "outputs",
});
app.factory.registerModelAndViewFn("UMLActivityPartition", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "groups",
});
app.factory.registerModelAndViewFn(
  ...
  _modelAndViewFn,
  { precondition: activityPrecondition, field: "groups" },
);
app.factory.registerModelAndViewFn(
...
app.factory.registerModelAndViewFn("UMLExpansionRegion", _modelAndViewFn, {
  precondition: activityPrecondition,
  field: "nodes",
});
app.factory.registerModelAndViewFn("UMLInputExpansionNode", _modelAndViewFn, {
...
app.factory.registerModelAndViewFn("UMLOutputExpansionNode", _modelAndViewFn, {
  modelType: "UMLExpansionNode",
  viewType: "UMLExpansionNodeView",
  precondition: pinPrecondition,
  field: "outputs",
...
app.factory.registerModelAndViewFn("UMLMetaClass", _modelAndViewFn, {
  modelInitializer: function (m) {
    m.name = "UMLClass";
  },
});
app.factory.registerModelAndViewFn("UMLExtension", _directedRelationshipFn, {
  precondition: extensionPrecondition,
});
