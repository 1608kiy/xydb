      ...
      document.addEventListener('DOMContentLoaded', function () {
        ...
        // 移动端触控下拉菜单（保留桌面 hover 行为）
        (function bindPomodoroUserMenu() {
          var container = document.getElementById('pm-user-menu-container');
          var btn = document.getElementById('pm-user-menu-btn');
          var menu = document.getElementById('pm-user-dropdown');
