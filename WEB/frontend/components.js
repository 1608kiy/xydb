...
function renderFooter(activePage) {
  ...
  <footer class="glass-tab py-1.5 px-2 sticky bottom-0 z-40">
    <div class="container mx-auto flex justify-around items-center">
      <a href="待办页面.html" class="tab-item ${activePage === 'todo' ? 'active text-blue-600' : 'text-black hover:text-blue-600'} flex flex-col items-center px-2 py-1 rounded-lg hover:bg-primary/10 transition-all duration-300"><i class="fas fa-list-alt text-base"></i><span class="text-[10px] mt-0.5">待办</span><span class="tab-indicator"></span></a>
      <a href="日历页面.html" class="tab-item ${activePage === 'calendar' ? 'active text-blue-600' : 'text-black hover:text-blue-600'} flex flex-col items-center px-2 py-1 rounded-lg hover:bg-primary/10 transition-all duration-300"><i class="fas fa-calendar text-base"></i><span class="text-[10px] mt-0.5">日历</span><span class="tab-indicator"></span></a>
      <a href="番茄钟页面.html" class="tab-item ${activePage === 'pomodoro' ? 'active text-blue-600' : 'text-black hover:text-blue-600'} flex flex-col items-center px-2 py-1 rounded-lg hover:bg-primary/10 transition-all duration-300"><i class="fas fa-clock text-base"></i><span class="text-[10px] mt-0.5">番茄钟</span><span class="tab-indicator"></span></a>
      <a href="数据周报页面.html" class="tab-item ${activePage === 'report' ? 'active text-blue-600' : 'text-black hover:text-blue-600'} flex flex-col items-center px-2 py-1 rounded-lg hover:bg-primary/10 transition-all duration-300"><i class="fas fa-chart-line text-base"></i><span class="text-[10px] mt-0.5">周报</span><span class="tab-indicator"></span></a>
      <a href="打卡页面.html" class="tab-item ${activePage === 'checkin' ? 'active text-blue-600' : 'text-black hover:text-blue-600'} flex flex-col items-center px-2 py-1 rounded-lg hover:bg-primary/10 transition-all duration-300"><i class="fas fa-check-circle text-base"></i><span class="text-[10px] mt-0.5">打卡</span><span class="tab-indicator"></span></a>
      <a href="个人中心页面.html" class="tab-item ${activePage === 'profile' ? 'active text-blue-600' : 'text-black hover:text-blue-600'} flex flex-col items-center px-2 py-1 rounded-lg hover:bg-primary/10 transition-all duration-300"><i class="fas fa-user text-base"></i><span class="text-[10px] mt-0.5">我的</span><span class="tab-indicator"></span></a>
    </div>
  </footer>
  `;
