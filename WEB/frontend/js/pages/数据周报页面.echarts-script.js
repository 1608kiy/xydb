      ...
      function initReportChartsOnce() {
        ...
        var chartTheme = isDark ? {
          ...
          tooltipText: '#ECFEFF',
          seriesMain: '#D97706',
          seriesMainAreaTop: 'rgba(245, 158, 11, 0.3)',
          seriesMainAreaBottom: 'rgba(245, 158, 11, 0.06)',
          seriesBarTop: '#F59E0B',
          seriesBarBottom: '#B45309',
          heatAreaA: 'rgba(255, 247, 237, 0.7)',
          heatAreaB: 'rgba(254, 243, 199, 0.8)',
          heatLegendBg: 'rgba(255, 251, 235, 0.88)',
          heatLegendText: '#92400E',
          heatRamp: ['#FFF7ED', '#FDE68A', '#FBBF24', '#F59E0B', '#D97706', '#B45309'],
          pieBorder: '#F7EED8',
          pieLabel: 'rgba(120, 53, 15, 0.88)',
          pieWork: '#F59E0B',
          pieStudy: '#D97706',
          pieLife: '#B45309',
          pieHealth: '#C2410C'
          ...
          heatAreaB: 'rgba(255,247,237,0.55)',
          heatLegendBg: 'rgba(255,255,255,0.88)',
          heatLegendText: '#7C2D12',
          heatRamp: ['#FFF7ED', '#FDE68A', '#FBBF24', '#F59E0B', '#D97706', '#B45309'],
          pieBorder: '#fff',
          pieLabel: 'rgba(120, 53, 15, 0.82)',
          pieWork: '#F59E0B',
          pieStudy: '#D97706',
          pieLife: '#B45309',
          pieHealth: '#C2410C'
